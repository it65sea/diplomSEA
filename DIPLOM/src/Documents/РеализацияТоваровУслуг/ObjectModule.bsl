...
// { Следенкин Е. 4.11.2024 
//Замечание М.Серегина 2:  необходимо проверять действует ли договор в дату реализации. 
//Если дата не попадает в период действия договора или договор не является договором абонентского обслуживания - необходимо выдавать ошибку.
Процедура ВКМ_ВыполнитьАвтозаполнение() Экспорт
	...
	//Замечание М.Серегина 2.2: сумма абонентской платы получается от договора через точку. 
    //Необходимо получить с помощью метода БСП вместе со всеми реквизитами.
