...
КонецПроцедуры   
	...
	//Замечание М.Серегина 4:  В форме Реализации для открытия вопроса используется метод ПоказатьВопрос. 
    //Начиная с платформы 8.3.18 лучше использовать ВопросАсинх.
 &НаКлиенте
