...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
    ...
    // { Следенкин Е. 01.09.2024 Добавление профиля "Специалист по обслуживанию клиентов"  
    ...
    //Следеникин Е. 01.09.24 } Конец добавления  
	
	// { Следенкин Е. 01.09.2024 Добавление профиля "Кадровик-расчетчик"  
